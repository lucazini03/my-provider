# ====================================================================================
# Setup Project
PROJECT_NAME := provider-providerlucawasm
...
IMAGES = provider-providerlucawasm
...
XPKGS = provider-providerlucawasm
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-providerlucawasm: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider ProviderLucaWasm CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider ProviderLucaWasm controllers
...
# This target prepares repo for your provider by replacing all "providerlucawasm"
